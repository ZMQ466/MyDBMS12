...
public class Main {
    ...
    private static void runTests() {
        ...
        String[] testCases = {
            ...
            // 正确的CREATE TABLE语句
            " CREATE TABLE students (id INT PRIMARY KEY,name VARCHAR(50) NOT NULL,age INT,grade FLOAT);",
            
            // 正确的INSERT语句
            "INSERT INTO students VALUES (1, 'Alice', 20, 85.5);",
            "INSERT INTO students VALUES (2, 'Bob', 21, 92.0);",
            "INSERT INTO students VALUES (3, 'Charlie', 19, 78.5);",
